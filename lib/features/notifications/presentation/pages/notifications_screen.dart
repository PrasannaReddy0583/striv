...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: AppColors.notifBackground,
        appBar: AppBar(
          backgroundColor: AppColors.notifBackground,
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Mark All as Read',
                      style: TextStyle(
                        color: AppColors.notifText.withOpacity(0.85),
                        fontSize: 13,
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _NotificationCard(
                      item: item,
                      cardColor: AppColors.notifCard,
                      titleColor: AppColors.notifText,
                      dotColor: AppColors.notifText,
                      onTap: () {
                        setState(() {
                          item.isUnread = false;
                        });

...
import 'package:striv/features/notifications/presentation/pages/notifications_screen.dart';
import 'package:striv/features/settings/presentation/pages/settings_screen.dart';
import 'package:striv/utils/app_palette.dart';
import 'package:striv/features/home/presentation/widgets/investments_card_widget.dart';
...
class _InvestorHomePageState extends State<InvestorHomePage> {
  ...
  late Future<List<PitchSummary>> _investmentsFuture;
  ...
  Future<List<PitchSummary>> _fetchInvestments() async {
    // Simulate API call
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FutureBuilder<List<PitchSummary>>(
...
class InvestmentsListSection extends StatelessWidget {
  final List<PitchSummary> investments;
...
class EmptyInvestmentsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(CupertinoIcons.briefcase, size: 48, color: AppColors.textSecondary),
          SizedBox(height: scale(context, 12)),
          Text(
            'No investments yet',
            style: TextStyle(
...
class EmptyMatchesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(CupertinoIcons.person_2, size: 48, color: AppColors.textSecondary),
          SizedBox(height: scale(context, 12)),
          Text(
